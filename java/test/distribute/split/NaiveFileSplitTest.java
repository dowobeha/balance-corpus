 ...
 */
public class NaiveFileSplitTest {
    ...
    private static final String outputPrefix = "../sample/naive/out.";

    private static final String outputIndexPrefix = "../sample/naive/index.";
	...
	Split splitter = null;
	try {
	    splitter = new NaiveFileSplit(filePath,parts);    
