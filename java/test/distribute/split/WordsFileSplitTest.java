 ...
 */
public class WordsFileSplitTest {
    ...
    private static final String outputPrefix = "../sample/words/out.";

    private static final String outputIndexPrefix = "../sample/words/index.";
	...
	Split splitter = null;
	try {
	    splitter = new WordsFileSplit(filePath,parts);    
